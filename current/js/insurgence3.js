...
localStorage.setItem("custom0-name", "Delta Squirtle");
localStorage.setItem("custom0-encounter", "delta-squirtle");
localStorage.setItem("custom0-nickname", "Fury");
